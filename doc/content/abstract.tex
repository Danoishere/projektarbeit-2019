...
Der präsentierte Lösungsansatz verwendet den Asynchronous Advantage Actor-Critic Algorithmus, einen der derzeit besten RL-Algorithmen, welcher verteiltes Lernen ermöglicht. Der präsentierte Ansatz orientiert sich dabei stark an der Ausgangslösung von Stephan Huschauer.
...
\begin{itemize}
    \item Andreas Weiler and Thilo Stadelmann for their great support during this work, for their helpful tips and for pushing us in the right direction.\\
