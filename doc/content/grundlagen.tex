...
All rail parts, independent of if it is a switch or not also allow to take the actions to do nothing (remain halted, or keep riding), to go forward or to brake.
...
\begin{itemize}
	...
	\item Minimal distance to target: The minimal cell distance to the target after this section is finished.
