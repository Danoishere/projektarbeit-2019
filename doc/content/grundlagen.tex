...
\end{cases}
\end{gather*}
All submissions to the flatland challenge get graded by the percentage of agents that made it to destionation. Additionally we use our own evaluation parcour with an increasing difficulty of environments to get more insight into the agents strenghts and weaknesses.
