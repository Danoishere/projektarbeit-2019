...
\end{algorithm}
While this makes sense in an environement where agents need to take an action on every timestep (such as Atari games), in flatland most of the time the only reasonable action is to move forward. Only around switches, the actions of an agent have acutual consequences.
