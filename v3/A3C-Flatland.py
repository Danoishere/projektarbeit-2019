...
class AC_Network():
    def __init__(self,a_size,scope,trainer):
        with tf.variable_scope(scope):
            ...
            self.input_map = tf.placeholder(shape=[None, constants.map_state_size[0], constants.map_state_size[1], constants.map_state_size[2]],dtype=tf.float32)
            self.input_grid = tf.placeholder(shape=[None, constants.grid_state_size[0], constants.grid_state_size[1], constants.grid_state_size[2],1],dtype=tf.float32)
            self.input_vector = tf.placeholder(shape=[None, constants.vector_state_size],dtype=tf.float32)
